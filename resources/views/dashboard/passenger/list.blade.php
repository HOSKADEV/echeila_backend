...
@section('title', __('app.passengers'))

@section('content')
  <!-- Header Section -->
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">{{ __('app.passengers') }}</h4>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('app.dashboard') }}</a></li>
          <li class="breadcrumb-item active">{{ __('app.passengers') }}</li>
        </ol>
      </nav>
    </div>
  </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
              <span>{{ __('passenger.stats.total') }}</span>
              <div class="d-flex align-items-end mt-2">
                <h4 class="mb-0 me-2">{{ $stats['total'] }}</h4>
              </div>
              <p class="mb-0">{{ __('passenger.stats.registered') }}</p>
            </div>
            <div class="avatar">
    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
              <span>{{ __('passenger.stats.active') }}</span>
              <div class="d-flex align-items-end mt-2">
                <h4 class="mb-0 me-2">{{ $stats['active'] }}</h4>
              </div>
              <p class="mb-0">{{ __('passenger.stats.active_label') }}</p>
            </div>
            <div class="avatar">
    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
              <span>{{ __('passenger.stats.banned') }}</span>
              <div class="d-flex align-items-end mt-2">
                <h4 class="mb-0 me-2">{{ $stats['banned'] }}</h4>
              </div>
              <p class="mb-0">{{ __('passenger.stats.banned_label') }}</p>
            </div>
            <div class="avatar">
    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
              <span>{{ __('passenger.stats.new') }}</span>
              <div class="d-flex align-items-end mt-2">
                <h4 class="mb-0 me-2">{{ $stats['new'] }}</h4>
              </div>
              <p class="mb-0">{{ __('passenger.stats.new_label') }}</p>
            </div>
            <div class="avatar">
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <div class="dataTables_wrapper dt-bootstrap5 no-footer">
        ...
        <x-table.datatable :columns="$columns" table-id="laravel_datatable" translation-prefix="passenger" />
