...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">{{ __('app.brands') }}</h4>
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <div class="dataTables_wrapper dt-bootstrap5 no-footer">
          ...
          <div class="col-md-10">
            <div
              ...
              <div class="dt-buttons btn-group flex-wrap">
                ...
                @permission(\App\Support\Enum\Permissions::BRAND_CREATE)
                <a href="{{ route('brands.create') }}" class="text-white text-decoration-none">
                  <button type="button" class="btn btn-primary">
                    <span class="tf-icons bx bx-plus"></span> @lang('app.add-new-brand')
                  </button>
                </a>
                @endpermission
              </div>
        ...
        <x-table.datatable :columns="$columns" table-id="laravel_datatable" translation-prefix="brand" />
