...
@section('title', __('app.edit-brand'))

@section('content')
  <!-- Header Section -->
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">{{ __('app.edit-brand') }}</h4>
  ...
  <form action="{{ route('brands.update', $brand->id) }}" method="POST" id="brand-form">
    @csrf
    @method('PATCH')
    <div class="row">
      <div class="col-xl">
            ...
            @foreach($locales as $locale)
              <div class="mb-3 col-md-6">
                ...
                <input 
                  ...
                  value="{{ old("name.{$locale}", $brand->translate('name', $locale) ?? '') }}" 
                  required>
                @error("name.{$locale}")
