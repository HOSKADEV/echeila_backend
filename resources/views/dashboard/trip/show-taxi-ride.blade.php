      ...
      <div>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="{{ route('trips.index', 'taxi_ride') }}">{{ __('trip.types.taxi_ride') }}</a></li>
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <div class="text-center mb-4">
              <div class="mb-3">
                <div class="avatar avatar-xl bg-label-primary rounded-circle mx-auto">
                    <div class="avatar-initial bg-label-primary rounded-circle">
                        <i class="bx bxs-taxi" style="font-size: 2.5rem;"></i>
                    </div>
                </div>
              </div>
              ...
              <br>
              <span class="{{ 'badge bg-label-' . \App\Constants\RideType::get_color($trip->detailable->ride_type) }}">
                {{ \App\Constants\RideType::get_name($trip->detailable->ride_type) }}
              </span>
            </div>
                ...
                @if($trip->client && $trip->client->client)
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      @if($trip->detailable->ride_type === \App\Constants\RideType::SHARED)
                        <span class="badge bg-label-info">
                          <i class="bx bx-group me-1"></i>{{ $trip->client->number_of_seats ?? 1 }} {{ __('trip.seats') }}
                        </span>
                      @endif
                    </div>
                  </div>
