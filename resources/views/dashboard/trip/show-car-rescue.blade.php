      ...
      <div>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="{{ route('trips.index', 'car_rescue') }}">{{ __('trip.types.car_rescue') }}</a></li>
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <div class="text-center mb-4">
              <div class="mb-3">
                <div class="avatar avatar-xl bg-label-danger rounded-circle mx-auto">
                    <div class="avatar-initial bg-label-danger rounded-circle">
                        <i class="bx bxs-car-battery" style="font-size: 2.5rem;"></i>
                    </div>
                </div>
              </div>
              ...
              <br>
              <span class="{{ 'badge bg-label-' . \App\Constants\MalfunctionType::get_color($trip->detailable->malfunction_type) }}">
                {{ \App\Constants\MalfunctionType::get_name($trip->detailable->malfunction_type) }}
              </span>
            </div>
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-3 d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    <small class="text-muted d-block">{{ __('trip.breakdown_location') }}</small>
                    <span class="fw-medium">
                      @if($trip->detailable->breakdownPoint)
                        {{ $trip->detailable->breakdownPoint->name ?? 'N/A' }}
                        <br>
                        <a href="{{ $trip->detailable->breakdownPoint->url }}" target="_blank" class="text-primary small">
                ...
                <li class="mb-3 d-flex align-items-center">
                  <i class="bx bx-wrench text-muted me-2"></i>
                  <div class="flex-grow-1">
                    <small class="text-muted d-block">{{ __('trip.malfunction_type') }}</small>
                    <span class="{{ 'badge bg-label-' . \App\Constants\MalfunctionType::get_color($trip->detailable->malfunction_type) }}">
                      {{ \App\Constants\MalfunctionType::get_name($trip->detailable->malfunction_type) }}
                    </span>
                  </div>
