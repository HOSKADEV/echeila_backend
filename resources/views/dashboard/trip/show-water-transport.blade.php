      ...
      <div>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="{{ route('trips.index', 'water_transport') }}">{{ __('trip.types.water_transport') }}</a></li>
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <div class="text-center mb-4">
              <div class="mb-3">
                <div class="avatar avatar-xl bg-label-info rounded-circle mx-auto">
                    <div class="avatar-initial bg-label-info rounded-circle">
                        <i class="bx bx-droplet" style="font-size: 2.5rem;"></i>
                    </div>
                </div>
              </div>
              ...
              <br>
              <span class="{{ 'badge bg-label-' . \App\Constants\WaterType::get_color($trip->detailable->water_type) }}">
                {{ \App\Constants\WaterType::get_name($trip->detailable->water_type) }}
              </span>
            </div>
            ...
            <div class="text-start">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="mb-3 d-flex align-items-center">
                  <i class="bx bx-droplet text-muted me-2"></i>
                  <div class="flex-grow-1">
                    <small class="text-muted d-block">{{ __('trip.water_type') }}</small>
                    <span class="{{ 'badge bg-label-' . \App\Constants\WaterType::get_color($trip->detailable->water_type) }}">
                      {{ \App\Constants\WaterType::get_name($trip->detailable->water_type) }}
                    </span>
                  </div>
                ...
                <li class="mb-3 d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <small class="text-muted d-block">{{ __('trip.quantity') }}</small>
                    <span class="fw-medium">{{ $trip->detailable->quantity ?? 'N/A' }} L</span>
                  </div>
                </li>
                <li class="mb-3 d-flex align-items-center">
