...
@section('title', __('app.edit-vehicle-model'))

@section('content')
  <!-- Header Section -->
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">{{ __('app.edit-vehicle-model') }}</h4>
  ...
  <form action="{{ route('vehicle-models.update', $vehicleModel->id) }}" method="POST" id="vehicle-model-form">
    @csrf
    @method('PATCH')
    <div class="row">
      <div class="col-xl">
            ...
            @foreach($locales as $locale)
              <div class="mb-3 col-md-6">
                ...
                <input 
                  ...
                  value="{{ old("name.{$locale}", $vehicleModel->translate('name', $locale) ?? '') }}" 
                  required>
                @error("name.{$locale}")
